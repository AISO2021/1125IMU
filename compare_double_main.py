        ...
        while not rospy.is_shutdown():
            ...
            if detect or white:
                ...
                if (buttons[0] and buttons[2]):
                    ...
                    print('imu_ang', imu_ang, 'autoware_ang', autoware_ang)

                    #autoware_power = culc_power(speed, autoware_ang)

                    if (-0.005 < autoware_ang < 0.005) and (-0.007 < imu_ang < 0.005):

                        imu_ang = comp_zero(speed, imu_ang)
